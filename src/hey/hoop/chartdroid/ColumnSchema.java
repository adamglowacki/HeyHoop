...
public final class ColumnSchema {
	...
	public static class Aspect {
		...
		public enum DatsetAspect {
			DATA(DATASET_ASPECT_DATA), AXES(DATASET_ASPECT_AXES), SERIES(
					DATASET_ASPECT_SERIES);
			String name;
	...
	public static final class PlotData implements BaseColumns {
		...
		public static final String CONTENT_TYPE_PLOT_DATA = ContentResolver.CURSOR_DIR_BASE_TYPE
				+ '/' + VND_TYPE_DECLARATION;
		public static final String CONTENT_TYPE_ITEM_PLOT_DATA = ContentResolver.CURSOR_ITEM_BASE_TYPE
				+ '/' + VND_TYPE_DECLARATION;
	}
