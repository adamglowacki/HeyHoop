...
public class IntentConstants {
	...
	public static class Meta {
		...
		public static class Axes {
			...
			/**
			 * Format string for the String.format() method, applied to
			 * horizontal axis labels.
			 */
			public static final String EXTRA_FORMAT_STRING_X = "com.googlecode.chartdroid.intent.extra.FORMAT_STRING_X";

			/**
			 * Format string for the String.format() method, applied to vertical
			 * axis labels.
			 */
			...
			/**
			 * Format string for the String.format() method, applied to
			 * secondary vertical axis labels.
			 */
		...
		public static class Series {
			...
			/**
			 * Boolean enabling automatic assignment of series colors
			 * evenly-spaced from the spectrum
			 */
			...
			/**
			 * Specify series marker styles in an array of int values. Types: 0
			 * = x 1 = circle 2 = triangle 3 = square 4 = diamond 5 = point
			 */
			public static final String EXTRA_SERIES_MARKERS = "com.googlecode.chartdroid.intent.extra.SERIES_MARKERS";

			/**
			 * Specify series line styles in an array of int values. Types: 0 =
			 * none, 1 = dotted 2 = dashed 3 = solid
			 */
